...
<div class="container mt-5">
    <div class="row">
        <div class="text-start">
            <img src="{{ URL::asset('/img/about-us.png') }}" alt="difarooms logo big">
        </div>
    </div>
    <div class="row mt-5">
        <div class="col" style="z-index: 0;">
            <h1 style="font-weight: 700; font-size: 32px; color: #47A2D6;">Tentang kami</h1>
        ...
        <div class="col-6 position-relative" style="z-index: 1;">
            ...
            <div class="" style="top: 310px; left: -60px; position: absolute;">
                <img src="{{ URL::asset('/img/home-tk2.png') }}" alt="assets 1" style="z-index: 1">
            </div>
            <div class="" style="top: 40px; left: 130px;position: absolute;">
                <img src="{{ URL::asset('/img/home-tk1.png') }}" alt="assets 2" style="z-index: 2">
            </div>
        </div>
    </div>
</div>
