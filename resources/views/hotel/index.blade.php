                ...
                <div class="card-img-overlay d-flex">
                    <div class="container my-auto">
                        ...
                        <div class="input-group pt-5">
                            <input type="text" class="form-control border-0" placeholder="Cari hotel"
                                aria-label="Cari hotel" aria-describedby="search-hotel" style="background-color: #D9D9D9">
                                            ...
                                            @foreach ($hotel_fascility as $fas)
                                                @if ($fas->ht_id == $htl->id)
                                                    <div class="col-6">
                                                        ...
                                                        @if ($fas->ramp == '1')
                                                            <p><img src="{{ URL::asset('/img/ramp.png') }}"
                                                                    alt="ramp-icon">ramp</p>
                                                        @else
                                                            <p class="disabled"><img
                                                        ...
                                                        @else
                                                            <p class="disabled"><span class="iconify"
                                                                    data-icon="fa6-solid:car"></span>Antar jemput bandara
                                                            </p>
                                                        @endif
                        ...
                        <h4 class="text-center card-header">Hotel Menu </h2>
                            <div class="card-body">
                                ...
                                <div id="style-selector-control" class="map-control">
                                    <input class="form-check-input" type="radio" name="hide-poi" id="hide-poi"
                                        checked />
