            ...
            <div class="col-sm-4">
                ...
                <div class="card border-0 shadow p-3 mb-5" style="border-radius:12px">
                    <div class="card-body p-2">
                        <h2 class="card-tittle" style="font-weight: 700; font-size:20px">Filter</h2>
                        {{-- kelas --}}
                        <h3 class="card-subtittle mt-4" style="font-weight: 600; font-size: 16px">Kelas Hotel</h2>
                            ...
                            <hr>
                            {{-- harga --}}
                            <h3 class="card-subtittle" style="font-weight: 600; font-size: 16px">Harga</h2>
                                ...
                                <hr>
                                {{-- fasilitas --}}
                                <h3 class="card-subtittle" style="font-weight: 600; font-size: 16px">Fasilitas</h2>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="kursi-roda"
                                            id="akses-kursi-roda">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="toilet-tinggi"
                                            id="toilet-tinggi">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="antar-jemput"
                                            id="antar-jemput">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                                        <button class="btn btn-outline-secondary border-0 me-md-2"
            ...
            <div class="col-sm-8 ps-4">
                <div class="row mb-3 mt-1">
                    ...
                    <div class="col-sm-10 ms-0">
                        ...
                        autocomplete="off">
                        <label class="btn btn-outline me-4" for="terdekat" style="color:#244D64; border-color:#244D64; border-radius: 12px; font-size: 16px">Terdekat</label>
                        <input type="radio" class="btn-check" name="options-outlined" id="paling-disukai"
                        autocomplete="off">
                        <label class="btn btn-outline mx-4" for="paling-disukai" style="color:#244D64; border-color:#244D64; border-radius: 12px; font-size: 16px">Paling Disukai</label>
                        <input type="radio" class="btn-check" name="options-outlined" id="harga-terendah"
                        autocomplete="off">
                        <label class="btn btn-outline mx-4" for="harga-terendah" style="color:#244D64; border-color:#244D64; border-radius: 12px; font-size: 16px">Harga Terendah</label>
                        <input type="radio" class="btn-check" name="options-outlined" id="harga-tertinggi"
                        autocomplete="off">
                        <label class="btn btn-outline ms-4" for="harga-tertinggi" style="color:#244D64; border-color:#244D64; border-radius: 12px; font-size: 16px">Harga Tertinggi</label>
                    </div>
                    {{-- filter terdekat --}}
                </div>
                {{-- list hotel --}}
