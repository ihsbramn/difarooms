                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link btn btn-outline-light rounded-pill px-4 me-2" type="button" href="{{ route('login') }}" style="font-size: 20px">{{ __('Login') }}</a>
                                </li>
                            @endif

                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link btn btn-light rounded-pill px-3 ms-2" type="button" href="{{ route('register') }}" style="color: #244D64; font-size: 20px">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
    ...
    <footer>
        <div class="container-fluid" style="background-color: #244D64">
            <div class="row">
                <div class="col-4 m-5">
                    <img src="{{URL::asset('/img/difarooms-logo.png')}}" alt="">
                    <p class="mt-2" style="font-weight: 300; font-size: 14px; color: #FFFFFF">Platform berbagi informasi <br>
