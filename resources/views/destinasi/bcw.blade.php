...
@section('content')
        ...
        <div class="row">
            <div class="col-12 px-0">
                <div class="card bg-dark text-white rounded-0 border-0" style="max-height: 467px; overflow:hidden">
                    <img src="{{ URL::asset('/img/bg-bcw.jpg') }}" class="card-img" alt="background">
                </div>
            </div>
            {{-- title n breadcrumb --}}
            <div class="col-12" style="background-color: #3B87B2">
                <h1 class="mt-5" style="font-weight: 700; font-size: 36px; color:#FFFFFF; padding-inline: 7rem">Braga City Walk</h1>
                <nav class="mb-5" style="--bs-breadcrumb-divider: '>'; color: #FFFFFF; padding-inline: 7rem"
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"
                            style="text-decoration: none; font-weight: 500; font-size: 14px; color: #FFFFFF">Braga Ciry Walk
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="container-fluid mt-5" style="padding-inline: 7rem">
        ...
        {{-- photos --}}
        <div id='scrolly'>
            <a href="{{ URL::asset('/img/bcw-1.jpg') }}" data-lightbox="img-bcw" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/bcw-1.jpg') }}' style="max-height: 300px; overflow: hidden; border-radius: 12px;">
            </a>
            <a href="{{ URL::asset('/img/bcw-2.jpg') }}" data-lightbox="img-bcw" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/bcw-2.jpg') }}' style="max-height: 300px; overflow: hidden; border-radius: 12px;">
            </a>
            <a href="{{ URL::asset('/img/bcw-3.jfif') }}" data-lightbox="img-bcw" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/bcw-3.jfif') }}' style="max-height: 300px; overflow: hidden; border-radius: 12px;">
            </a>
            <a href="{{ URL::asset('/img/bcw-4.jpg') }}" data-lightbox="img-bcw" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/bcw-4.jpg') }}' style="max-height: 300px; overflow: hidden; border-radius: 12px;">
            </a>
            <a href="{{ URL::asset('/img/bcw-1.jpg') }}" data-lightbox="img-bcw" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/bcw-1.jpg') }}' style="max-height: 300px; overflow: hidden; border-radius: 12px;">
            </a>
            ...
            <a href="{{ URL::asset('/img/bcw-3.jpg') }}" data-lightbox="img-bcw" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/bcw-3.jpg') }}' style="max-height: 300px; overflow: hidden; border-radius: 12px;">
            </a>
            <a href="{{ URL::asset('/img/bcw-4.jpg') }}" data-lightbox="img-bcw" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/bcw-4.jpg') }}' style="max-height: 300px; overflow: hidden; border-radius: 12px;">
            </a>
        ...
        <div class="row mt-5">
            ...
            <div class="col-5 position-relative">
                {{-- map --}}
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.778623554681!2d107.60695301519321!3d-6.91704939500216!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e7ca95f0e803%3A0xc139b12f4a43419a!2sBraga%20city%20walk!5e0!3m2!1sen!2sid!4v1660381269661!5m2!1sen!2sid"
