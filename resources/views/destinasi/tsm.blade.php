    ...
    <div class="container-fluid mt-5" style="padding-inline: 7rem">
        ...
        <div class="row">
            ...
            <ul class="ms-4">
                ...
                <li>
                    <p style="text-align: justify; font-weight: 400; font-size: 16px;">Toilet yang dapat diakses kursi roda</p>
                </li>
                <li>
                    <p style="text-align: justify; font-weight: 400; font-size: 16px;">Lift yang dapat diakses kursi roda</p>
                </li>
            </ul>
        </div>
