...
@section('content')
        ...
        <div class="row">
            <div class="col-12 px-0">
                <div class="card bg-dark text-white rounded-0 border-0" style="max-height: 467px; overflow:hidden">
                    <img src="{{ URL::asset('/img/bg-tsm.jpg') }}" class="card-img" alt="background">
                </div>
            </div>
            {{-- title n breadcrumb --}}
            <div class="col-12" style="background-color: #3B87B2">
                <h1 class="mt-5" style="font-weight: 700; font-size: 36px; color:#FFFFFF; padding-inline: 7rem">Trans
                    Studio Mall</h1>
                <nav class="mb-5" style="--bs-breadcrumb-divider: '>'; color: #FFFFFF; padding-inline: 7rem"
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"
                            style="text-decoration: none; font-weight: 500; font-size: 14px; color: #FFFFFF">Trans Studio
                            Mall
                        </li>
                    </ol>
                </nav>
    ...
    <div class="container-fluid mt-5" style="padding-inline: 7rem">
        ...
        {{-- photos --}}
        <div id='scrolly'>
            <a href="{{ URL::asset('/img/tsm-1.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-1.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-1">
            </a>
            <a href="{{ URL::asset('/img/tsm-2.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-2.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-2">
            </a>
            <a href="{{ URL::asset('/img/tsm-3.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-3.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-3">
            </a>
            <a href="{{ URL::asset('/img/tsm-4.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-4.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-4">
            </a>
            <a href="{{ URL::asset('/img/tsm-1.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-1.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-5">
            </a>
            <a href="{{ URL::asset('/img/tsm-2.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-2.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-6">
            </a>
            <a href="{{ URL::asset('/img/tsm-3.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-3.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-7">
            </a>
            <a href="{{ URL::asset('/img/tsm-4.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-4.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-8">
            </a>
            <a href="{{ URL::asset('/img/tsm-2.jpg') }}" data-lightbox="img-tsm" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/tsm-2.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="trans studio-9">
            </a>
        </div>
        <div class="row mt-5">
            <div class="col-7">
                ...
                <p style="font-weight: 400; font-size: 16px;">
                    Trans Studio Bandung adalah sebuah mal sekaligus taman bermain indoor terbesar pertama di Indonesia yang
                    terletak di Kota Bandung, Jawa Barat. Trans Studio Bandung dibangun di lahan seluas 17 ha. Wahana
                    yang terdapat didalamnya menawarkan petualangan dan sensasi untuk para penyuka adrenalin.
                    <br>
                    <br>
                    <span style="font-weight: 700; font-size: 16px;">Sejarah</span>
                    <br>
                    <br>
                    Grand Opening Trans Studio Bandung diadakan pada tanggal 17 Juni 2011 disiarkan secara langsung oleh
                    Trans TV dan Trans7 dan dibuka untuk umum mulai tanggal 18 Juni 2011.
                    <br><br>
                    Roller Coaster di Trans Studio Mall Bandung.
                    Trans Studio Mall Bandung atau disingkat TSM (dahulu Bandung Supermal (BSM)) merupakan pusat
                    pembelanjaan terbesar di Bandung yang upacara diresmikan hingga upacara pembukaan sejak pada tanggal 25
                    Oktober 2001.
                    <br>
                    <br>
                    <span style="font-weight: 700; font-size: 16px;">Harga Masuk</span>
                    <br>
                    <br>
                    Harga tiket masuk Trans Studio Bandung adalah:
                    <br>
                    <ul>
                        <li>Selasa s.d. Jum'at : Rp 180.000,- (Seratus Delapan puluh ribu rupiah)</li>
                        <li>Sabtu dan Minggu / Hari Libur / Peakseason : Rp280.000,- (Dua ratus Delapan puluh ribu rupiah)</li>
                    </ul>
                    <br>
                    Tambahan Rp200.000,- (Dua ratus ribu rupiah) untuk VIP Access (fast track) di Weekdays, dan tambahan
                    Rp300.000,- (Tiga ratus ribu rupiah) untuk VIP Access (fast track) di Weekends/Peakseason VIP Access
                    berfungsi untuk Jalur Antrian Cepat dengan Pintu Khusus.
                    <br>
                    Harga Tiket Masuk berlaku untuk seluruh wahana dan atraksi sepuasnya atau dapat berkali-kali.
                    <br>
                    Pembelian tiket bisa melalui www.transstudiobandung.com atau di loket tiket langsung.
                    <br>
                    Jam Operasional Trans Studio Bandung adalah Selasa-Minggu 10.00-17.00 WIB (Senin Libur).
                </p>
            </div>
            <div class="col-5 position-relative">
                {{-- map --}}
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.714974142755!2d107.63405531519328!3d-6.924634894996821!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e7d87c2b519b%3A0x4d60c5efa75acded!2sTrans%20Studio%20Bandung!5e0!3m2!1sen!2sid!4v1660380650480!5m2!1sen!2sid"
        ...
        <div class="row">
            ...
            <ul class="ms-4">
                ...
                <li>
                    <p style="font-weight: 400; font-size: 16px;">Lift yang dapat diakses kursi roda</p>
                </li>
            </ul>
        </div>
