    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col px-0">
                <div class="card bg-dark text-white rounded-0 border-0" style="max-height: 467px; overflow:hidden">
                    <img src="{{ URL::asset('/img/bg-lombok.jpg') }}" class="card-img" alt="background">
                    <div class="card-img-overlay d-flex">
                        <div class="container my-auto">
                            <h1 style="font-size: 40px; font-weight:800">Nikmati alam Pulau Lombok
                            </h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mx-10 mt-5">
                ...
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"
                            style="font-weight: 500; font-size: 14px; color: #47A2D6;">Lombok</li>
                    </ol>
                </nav>
            </div>
            {{-- text content --}}
            ...
            <div class="col-6 mt-3">
                <p style="font-weight: 400; font-size: 24px;">Pulau Lombok (jumlah penduduk pada tahun
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card h-100 border-0">
                            <img src="{{ URL::asset('/img/lbk-1.jpg') }}" class="card-img h-100" alt="foto kota lombok 1" style="border-radius: 12px;">
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 border-0">
                            <img src="{{ URL::asset('/img/lbk-2.jpg') }}" class="card-img h-100" alt="foto kota lombok 2" style="border-radius: 12px;">
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 border-0">
                            <img src="{{ URL::asset('/img/lbk-3.jpg') }}" class="card-img h-100" alt="foto kota lombok 3" style="border-radius: 12px;">
                        </div>
                    </div>
                </div>
            </div>
