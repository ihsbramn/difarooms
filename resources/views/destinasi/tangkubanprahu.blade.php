        ...
        <div class="row">
            <div class="col-12 px-0">
                <div class="card bg-dark text-white rounded-0 border-0" style="max-height: 467px; overflow:hidden">
                    <img src="{{ URL::asset('/img/bg-tangkuban.jpg') }}" class="card-img" alt="background">
                </div>
            </div>
            <div class="col-12" style="background-color: #3B87B2">
                <h1 class="mt-5" style="font-weight: 700; font-size: 36px; color:#FFFFFF; padding-inline: 7rem">Tangkuban Perahu</h1>
                <nav class="mb-5" style="--bs-breadcrumb-divider: '>'; color: #FFFFFF; padding-inline: 7rem"
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"
                            style="text-decoration: none; font-weight: 500; font-size: 14px; color: #FFFFFF">Tangkuban Perahu
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-7">
                <p style="font-weight: 400; font-size: 16px; text-align:justify;">
                    ...
                    salah satu gunung yang terletak di Provinsi Jawa Barat, Indonesia. Sekitar 20 km ke arah utara Kota
                    Bandung, dengan rimbun pohon pinus dan hamparan kebun teh di sekitarnya, Gunung Tangkuban Parahu
                    mempunyai ketinggian setinggi 2.084 meter. Bentuk gunung ini adalah Stratovulcano dengan pusat erupsi
                    yang berpindah dari timur ke barat. Jenis batuan yang dikeluarkan melalui letusan kebanyakan adalah lava
                    dan sulfur, mineral yang dikeluarkan adalah sulfur belerang, mineral yang dikeluarkan saat gunung tidak
                    aktif adalah uap belerang. Daerah Gunung Tangkuban Parahu dikelola oleh Perum Perhutanan. Suhu rata-rata
                    hariannya adalah 17oC pada siang hari dan 2 °C pada malam hari.
                    <br>
                    <br>
                    <span style="font-weight: 700; font-size: 16px;">Sejarah</span>
                    <br>
                    <br>
                    Gunung Tangkuban Parahu terbentuk sekitar 90.000 tahun lalu di Kaldera Sunda. Gunung ini, menurut T.
                    Bachtiar dan Dewi Syafriani dalam buku Bandung Purba, lebih muda dari Gunung Burangrang. Gunung
                    Burangrang yang terletak di sisi barat Gunung Tangkuban Parahu terbentuk sekitar 210.000 hingga 105.000
                    tahun lalu. Menurut T. Bachtiar, Gunung Tangkuban Parahu lahirnya setelah terbentuknya Sesar Lembang.
                    Ketika Gunung Tangkuban Parahu meletus, sebagian material alirannya yang mengalir ke selatan tertahan di
                    kaki patahan.
                </p>
            </div>
            <div class="col-5 position-relative">
                {{-- map --}}
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15848.335844048761!2d107.60102593634348!3d-6.759616163224247!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e1ddc59713db%3A0xa01c96b73428fedc!2sTangkuban%20Perahu!5e0!3m2!1sen!2sid!4v1658409579627!5m2!1sen!2sid"
