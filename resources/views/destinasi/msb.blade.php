...
@section('content')
        ...
        <div class="row">
            <div class="col-12 px-0">
                <div class="card bg-dark text-white rounded-0 border-0" style="max-height: 467px; overflow:hidden">
                    <img src="{{ URL::asset('/img/bg-msb.jpg') }}" class="card-img" alt="background">
                </div>
            </div>
            {{-- title n breadcrumb --}}
            <div class="col-12" style="background-color: #3B87B2">
                <h1 class="mt-5" style="font-weight: 700; font-size: 36px; color:#FFFFFF; padding-inline: 7rem">Museum Sri
                    Baduga</h1>
                <nav class="mb-5" style="--bs-breadcrumb-divider: '>'; color: #FFFFFF; padding-inline: 7rem"
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"
                            style="text-decoration: none; font-weight: 500; font-size: 14px; color: #FFFFFF">Museum Sri
                            Baduga
                        </li>
                    </ol>
                </nav>
    ...
    <div class="container-fluid mt-5" style="padding-inline: 7rem">
        ...
        {{-- photos --}}
        <div id='scrolly'>
            <a href="{{ URL::asset('/img/msb-1.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-1.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-1">
            </a>
            <a href="{{ URL::asset('/img/msb-2.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-2.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-2">
            </a>
            <a href="{{ URL::asset('/img/msb-3.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-3.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-3">
            </a>
            <a href="{{ URL::asset('/img/msb-4.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-4.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-4">
            </a>
            <a href="{{ URL::asset('/img/msb-5.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-5.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-5">
            </a>
            <a href="{{ URL::asset('/img/msb-2.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-2.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-6">
            </a>
            <a href="{{ URL::asset('/img/msb-3.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-3.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-7">
            </a>
            <a href="{{ URL::asset('/img/msb-4.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-4.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-8">
            </a>
            <a href="{{ URL::asset('/img/msb-2.jpg') }}" data-lightbox="img-msb" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/msb-2.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum sri baduga-9">
            </a>
        </div>
        <div class="row mt-5">
            <div class="col-7">
                ...
                <p style="font-weight: 400; font-size: 16px;">
                    Museum Sri Baduga merupakan sebuah museum yang terletak di kota Bandung, Jawa Barat,
                    Indonesia.
                    <br><br>
                    Museum ini dikelola oleh pemerintah provinsi Jawa Barat, yang mulai didirikan pada tahun 1974 dengan
                    memanfaatkan bangunan lama bekas Kawedanan Tegallega, yang kemudian diresmikan pada tanggal 5 Juni 1980
                    oleh Menteri Pendidikan dan Kebudayaan waktu itu, Daoed Joesoef.
                    <br><br>
                    Penamaan museum ini diambil dari gelar salah seorang raja Pajajaran, Sri Baduga Maharaja sebagaimana
                    tertulis pada Prasasti Batutulis. Dan kemudian ditetapkan melalui Kepmendikbud nomor 02223/0/1990
            ...
            <div class="col-5 position-relative">
                {{-- map --}}
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.605804825047!2d107.60121331535737!3d-6.9376260698414844!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e899f41b0e7d%3A0xc6af38b146fd23ac!2sSri%20Baduga%20Museum!5e0!3m2!1sen!2sid!4v1660381132141!5m2!1sen!2sid"
