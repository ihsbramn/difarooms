...
@section('content')
    ...
    <div class="container-fluid mt-5" style="padding-inline: 7rem">
        ...
        <div id='scrolly'>
            <a href="{{ URL::asset('/img/geo-1.jpg') }}" data-lightbox="img-geo" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/geo-1.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum geologi-1">
            </a>
            <a href="{{ URL::asset('/img/geo-3.jpg') }}" data-lightbox="img-geo" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/geo-3.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum geologi-2">
            </a>
            <a href="{{ URL::asset('/img/geo-4.jpg') }}" data-lightbox="img-geo" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/geo-4.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum geologi-3">
            </a>
            <a href="{{ URL::asset('/img/geo-5.jpg') }}" data-lightbox="img-geo" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/geo-5.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum geologi-4">
            </a>
            <a href="{{ URL::asset('/img/geo-6.jpg') }}" data-lightbox="img-geo" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/geo-6.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum geologi-5">
            </a>
            <a href="{{ URL::asset('/img/geo-7.jpg') }}" data-lightbox="img-geo" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/geo-7.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum geologi-6">
            </a>
            <a href="{{ URL::asset('/img/geo-4.jpg') }}" data-lightbox="img-geo" style="margin-right: 30px">
                <img id='img-scroll' src='{{ URL::asset('/img/geo-4.jpg') }}'
                    style="max-height: 300px; overflow: hidden; border-radius: 12px;" alt="museum geologi-7">
            </a>
        </div>
        <div class="row mt-5">
            <div class="col-7">
        ...
        <div class="row mt-3">
            ...
            <ul class="ms-4">
                <li>
                    <p style="font-weight: 400; font-size: 16px;">Parkir mobil dengan akses kursi roda
                    </p>
                </li>
                <li>
                    <p style="font-weight: 400; font-size: 16px;">Pintu masuk yang dapat diakses kursi
                        roda</p>
                </li>
                <li>
                    <p style="font-weight: 400; font-size: 16px;">Lift yang dapat diakses kursi roda
                    </p>
                </li>
                <li>
                    <p style="font-weight: 400; font-size: 16px;">Toilet yang dapat diakses kursi roda
                    </p>
                </li>
            </ul>
        </div>
